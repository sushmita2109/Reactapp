                    ...
                    <div className="col-12 col-md-9">
                       <LocalForm onSubmit={(values)=>this.handleSubmit(values)}>
                           ...
                           <Row className="form-group">
                               ...
                               <Col md={10}>
                                   <Control.text model=".telnum" id="telnum" name="telnum" placeholder="Telephone number" className="form-control"  validators={{
                           ...
                           <Row className="form-group">
                               <Col md={{size : 6,offset: 2}}>
                                   <div className="form-check">
                                       <Label check>
                                           <Control.checkbox model=".agreed" name="agreed" className="form-check-input"  />{' '}
                           ...
                           <Row className="form-group">
                               ...
                               <Col md={10}>
                                   <Control.textarea model=".message" id="message" name="message" placeholder="Feedback" row="12" className="form-control"  />
                               </Col>
                               </Row>
                           <Row className="form-group">
